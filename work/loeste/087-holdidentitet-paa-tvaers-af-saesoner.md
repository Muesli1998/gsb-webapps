...
**Afklaring af 204 vs. 206:** Runde 3's 206 Liga-forsøg tæller to 2020-tekstduplikater særskilt: `Taber semifinale 1 og 2`/samme med afsluttende punktum samt `Vinder semifinale 1 og 2`/samme med punktum. Fordi runde 3's suffix-parser ser afsluttende `2` forskelligt før/efter punktummet, blev de fire rå noder til fire forsøg. Runde 4 samler hvert par som én placeholder og viser derfor 204 noder samt 55 — ikke 57 — reelle `ingen_tekstlig_efterfølger`-tilfælde. Dette er en display-/parserartefakt, ikke et aliasfund.
