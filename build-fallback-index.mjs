...
const out=errs.map(e=>{const m=byId.get(String(e.matchId))||{}; const url=`https://www.badmintonplayer.dk/DBF/HoldTurnering/Stilling/#5,${m.season??e.season},${m.leagueGroupId??''},${m.ageGroupId??''},1,8,,${e.matchId},1093,`; return {...e,ageGroupId:m.ageGroupId??null,leagueGroupId:m.leagueGroupId??null,roundDate:m.roundDate??null,gameTime:m.gameTime??null,badmintonPlayerUrl:url};});
